...
public class HelloServerOutBoundHandler2 extends ChannelOutboundHandlerAdapter {

    private static final String CLASSNAME = HelloServerOutBoundHandler2.class.getSimpleName();
